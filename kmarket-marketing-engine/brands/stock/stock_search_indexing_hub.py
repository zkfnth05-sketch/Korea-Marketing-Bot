...
class StockSearchIndexingHub:
    ...
    def get_target_urls(self) -> List[str]:
        ...
        urls = [
            ...
            f"{self.LANDING_URL}condition-search",
            f"{self.LANDING_URL}calculators",
            self.SITEMAP_URL,
            "https://stockmaster-ai.vercel.app/sitemap_stock.xml"
        ]

        # sitemap_stock.xml이 생성되어 있으면 대표 URL 추가 로드
        sitemap_path = PROJECT_ROOT / "outputs" / "sitemaps" / "sitemap_stock.xml"
