# -*- coding: utf-8 -*-
"""
📈 StockMaster Multi Publisher (3대 블로그 플랫폼 동시 발행 오케스트레이터)
=========================================================================
...
class StockMultiPublisher:
    ...
    def publish_all(
        ...
        tags = article_pkg.get("tags", ["주식투자", "주식AI", "StockMaster"])
        ...
        # 1. 네이버 블로그
        try:
            logger.info("🚀 [MultiPub-Stock] 네이버 블로그 발행 시작...")
            ...
            logger.error(f"❌ [MultiPub-Stock] 네이버 실패: {e}")
            results["naver"] = {"status": "error", "message": str(e)}

        # 2. 티스토리
        try:
            logger.info("🚀 [MultiPub-Stock] 티스토리 블로그 발행 시작...")
            ...
            logger.error(f"❌ [MultiPub-Stock] 티스토리 실패: {e}")
            results["tistory"] = {"status": "error", "message": str(e)}

        # 3. 브런치스토리
        try:
            logger.info("🚀 [MultiPub-Stock] 브런치스토리 발행 시작...")
            ...
            logger.error(f"❌ [MultiPub-Stock] 브런치 실패: {e}")
