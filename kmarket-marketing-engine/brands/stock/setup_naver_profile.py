# -*- coding: utf-8 -*-
"""
Stock Master 전용 네이버 영구 브라우저 프로필 1회 생성 도구
========================================================================================
- 브랜드: 📈 Stock Master (주식 AI)
- 전용 계정: zkfnth02
- 프로필 경로: brands/stock/naver_browser_profile/
...
def main():
    print("\n" + "=" * 70)
    print("🔑 [📈 Stock Master 주식 AI] 네이버 영구 브라우저 프로필 1회 세팅 도구")
    print("=" * 70)
    print(f"👉 Stock Master 전용 계정: [ zkfnth02 ]")
    print(f"👉 저장 위치: {PROFILE_DIR}")
    print("-" * 70)
    print("1. 실제 크롬 브라우저가 전용 영구 프로필 모드로 실행됩니다.")
    print("2. 네이버 로그인 화면에서 [zkfnth02] 계정으로 로그인해 주세요.")
    ...
    try:
        ...
        with sync_playwright() as p:
            ...
            context.close()
        print(f"🎉 [성공] 총 {len(cookies)}개의 최신 롤링 쿠키가 Stock Master 영구 보관함에 완벽하게 동기화되었습니다!")
