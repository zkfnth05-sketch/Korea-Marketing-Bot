# -*- coding: utf-8 -*-
"""
📈 StockMaster Naver Login Helper (주식 전용 네이버 블로그 무인 자동 발행용 1회 세션 저장기)
========================================================================================
- 브랜드: 📈 Stock Master (주식 AI)
- 전용 계정: zkfnth02
- 프로필 디렉터리: brands/stock/naver_browser_profile/
- 역할:
  ...
  4. 이후 일상 증시 브리핑/칼럼 자동 발행 시 재로그인 불필요 (100% 무인 자동화)
"""
...
async def run_login_flow():
    print("=" * 70)
    print("📈 [Stock Master 주식 AI] 네이버 영구 로그인 1회 연동기")
    print(f"👉 전용 계정: [ zkfnth02 ]")
    ...
    async with async_playwright() as p:
        ...
        print("\n🎉 [대성공!] Stock Master 네이버 로그인이 정상 감지되었습니다!")
        ...
        accounts_data["credentials"]["naver_blog_id"] = "zkfnth02"
        ...
        print(f"💾 2. accounts.json 네이버 계정(zkfnth02) 영구 등록 완료!")
        print("\n✨ 이제부터 Stock Master 마케팅봇이 증시 브리핑 및 블로그에 완전 무인으로 영구 자동 활동합니다!")
