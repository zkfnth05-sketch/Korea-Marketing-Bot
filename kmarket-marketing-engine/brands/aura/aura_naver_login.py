# -*- coding: utf-8 -*-
"""
Aura Naver Login Helper (네이버 블로그 및 지식iN 무인 자동화용 1회 세션 영구 저장기)
=============================================================================
- 브랜드: 💖 Aura (AI 데이팅)
- 전용 계정: zkfnth01
- 프로필 디렉터리: brands/aura/naver_browser_profile/
- 역할:
  1. 실제 브라우저 창을 화면에 띄움 (영구 프로필 모드)
  2. 대표님께서 스마트폰 QR코드 또는 아이디/비번으로 1회 정상 로그인 수행
  3. 로그인 완료 감지 시 naver_browser_profile, naver_session.json, accounts.json 3중 자동 영구 저장
  4. 이후 일상 지식iN 답변 및 블로그 자동 발행 시 재로그인 불필요 (100% 무인 자동화)
"""
...
async def run_login_flow():
    print("=" * 70)
    print("💖 [Aura 데이팅] 네이버 영구 로그인 1회 연동기")
    print(f"👉 전용 계정: [ zkfnth01 ]")
    ...
    async with async_playwright() as p:
        ...
        print(f"💾 2. accounts.json 네이버 계정(zkfnth01) 영구 등록 완료!")
        print("\n✨ 이제부터 Aura 마케팅봇이 지식iN 답변 및 블로그에 완전 무인으로 영구 자동 활동합니다!")
