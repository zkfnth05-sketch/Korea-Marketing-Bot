        ...
        async with async_playwright() as p:
            ...
            try:
                ...
                if title_ph:
                    ...
                    logger.warning("⚠️ [Naver-Insurance] 제목 입력란을 찾지 못했습니다.")
                ...
                if image_paths and len(image_paths) > 0 and Path(image_paths[0]).exists():
                    ...
                    try:
                        ...
                        logger.warning(f"⚠️ [Naver-Insurance] 사진 업로드 예외: {e}")
                ...
                # 10. 발행 완료 및 리다이렉트 대기
                logger.info("⏳ [Naver-Insurance] 발행 완료 후 블로그 글 페이지 이동 대기...")
                try:
                ...
                final_url = page.url
                logger.info(f"✅ [Naver-Insurance] 발행 후 리다이렉트 URL: {final_url}")
                ...
                logger.info(f"🎉 [Naver-Insurance] 최종 공개 발행 성공! {post_url}")
                return {
                    "status": "success",
