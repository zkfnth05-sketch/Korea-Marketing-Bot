# -*- coding: utf-8 -*-
"""
InsureBalance 전용 네이버 영구 브라우저 프로필 1회 생성 도구
========================================================================================
- 브랜드: 🛡️ InsureBalance (보험비교)
- 전용 계정: thefirst-life
- 프로필 경로: brands/insurance/naver_browser_profile/
...
def main():
    print("\n" + "=" * 70)
    print("🔑 [🛡️ InsureBalance 보험비교] 네이버 영구 브라우저 프로필 1회 세팅 도구")
    print("=" * 70)
    print(f"👉 InsureBalance 전용 계정: [ thefirst-life ]")
    print(f"👉 저장 위치: {PROFILE_DIR}")
    print("-" * 70)
    print("1. 실제 크롬 브라우저가 전용 영구 프로필 모드로 실행됩니다.")
    print("2. 네이버 로그인 화면에서 [thefirst-life] 계정으로 로그인해 주세요.")
    ...
    try:
        ...
        with sync_playwright() as p:
            ...
            context.close()
        print(f"🎉 [성공] 총 {len(cookies)}개의 최신 롤링 쿠키가 InsureBalance 영구 보관함에 완벽하게 동기화되었습니다!")
        print("💡 이제 봇이 지식iN/블로그를 100% 무인으로 가동합니다.\n")
