# -*- coding: utf-8 -*-
"""
🛡️ InsureBalance Multi Publisher (🛡️ 3대 채널 옴니 블로그 무인 자동 배포 매니저)
=============================================================================
- 역할:
...
class InsuranceMultiPublisher:
    """InsureBalance 3대 채널 옴니 블로그 동시 배포 컨트롤러 (완전 독립 레고 블록)"""
    ...
    def publish_all(
        ...
        logger.info(f"\n" + "=" * 60)
        logger.info(f"🚀 [InsureBalance 3대 채널 옴니 배포 가동] 주제 #{topic_id}")
