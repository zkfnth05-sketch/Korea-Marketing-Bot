...
async def run_login_flow():
    print("=" * 60)
    print("🛡️ [InsureBalance 보험 비교 네이버 블로그 1회 간편 연동기]")
    ...
    async with async_playwright() as p:
        ...
        print(f"💾 1. 보험 전용 브라우저 세션 영구 저장 완료: {SESSION_FILE.name}")
        ...
        print(f"💾 2. accounts.json 보험 비교 네이버 계정 및 세션 쿠키 자동 등록 완료!")
        print("\n✨ 이제부터 마케팅봇이 네이버 블로그에 완전 무인으로 16:9 감성 사진 + 1,300자 원고를 자동 발행합니다!")
