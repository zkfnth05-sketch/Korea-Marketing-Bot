# -*- coding: utf-8 -*-
"""
Insurance Runner (보험 비교 InsureBalance 독립 실행 스크립트)
Usage:
    python run_insurance.py               # 드라이런(테스트 모드)
    python run_insurance.py --live        # 실제 라이브 발행 모드
    python run_insurance.py --blog-now    # 3대 채널 옴니 블로그 1회 즉시 무인 배포
"""
...
def main():
    if "--blog-now" in sys.argv or "-bn" in sys.argv:
        print("\n==============================================")
        print("🛡️ [InsureBalance] 2,000자 전문 칼럼 + 16:9 맞춤 사진 1장 즉시 생성 & 3대 채널 배포")
        print("==============================================\n")
        ...
        print(f"  - 🔗 랜딩 URL: https://insurebalance.co.kr")
